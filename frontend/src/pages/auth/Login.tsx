...
export default function Login() {
  ...
  return (
    <div className="min-h-screen flex font-sans bg-[#111111] selection:bg-[#ffd000] selection:text-black relative">
      ...
      <Link to="/" className="absolute top-6 right-6 lg:top-8 lg:right-12 z-50 flex items-center gap-2 text-xs font-bold text-zinc-500 hover:text-white uppercase tracking-wider transition-colors">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-[#0a0a0a] relative flex-col justify-between p-12 overflow-hidden border-r border-zinc-900">
        ...
        <div className="relative z-10 flex items-center gap-3">
          <Link to="/" className="text-2xl font-black text-white tracking-tighter uppercase hover:text-[#ffd000] transition-colors">
            Construction Hub
          </Link>
        </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-16">
        <div className="w-full max-w-lg animate-in fade-in slide-in-from-bottom-8 duration-700 mt-12 lg:mt-0">
          <div className="lg:hidden flex items-center gap-3 mb-10">
            <Link to="/" className="text-xl font-black text-white tracking-tighter uppercase">
              Construction Hub
            </Link>
          </div>

          <h1 className="text-4xl font-black text-white mb-2 uppercase tracking-tighter">Log in</h1>
          <p className="text-zinc-500 mb-8 font-medium">Enter your credentials to access your role dashboard.</p>

          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              <label className="block text-xs font-bold text-zinc-400 uppercase tracking-wider mb-2">Work Email</label>
              <input
                type="email"
                value={email}
