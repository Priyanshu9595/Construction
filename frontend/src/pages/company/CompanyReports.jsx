          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {reportsList.map((report, idx) => (
              ...
              >
                ...
                <h3 className="mt-3 font-extrabold text-slate-900 text-base group-hover:text-blue-600 transition-colors">
                  {report.title}
                </h3>
            ...
            {isLoading ? (
              ...
              <div className="space-y-4">
                ...
                <div className="p-3 bg-rose-50 rounded-lg">
                  ...
                  <p className="text-xl font-extrabold text-rose-700 mt-1 flex items-center">
                    <IndianRupee size={16} className="mr-0.5" />
