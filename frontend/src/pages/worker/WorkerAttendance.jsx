...
import { CalendarDays, Clock, Loader2, Building2 } from "lucide-react";
              ...
              {data?.length === 0 ? (
                ...
                data?.map((record) => (
                  ...
                  >
                    ...
                    <td className="p-5">
                      <span
                        className={`inline-flex items-center rounded-lg px-2.5 py-1 text-xs font-black uppercase tracking-wider ${record.status === "present" ? "bg-emerald-50 text-emerald-700 border border-emerald-200" : "bg-red-50 text-red-700 border border-red-200"}`}
                      >
                        {record.status}
                      </span>
                    </td>
                    ...
                    <td className="p-5 font-bold text-slate-700">
                      {record.totalWorkingMinutes
                        ? `${(record.totalWorkingMinutes / 60).toFixed(1)} hrs`
                        : "-"}
                    </td>
                  </tr>
                ))
